...
def output_version_headers():
  ...
  with open(os.path.join(OutputFolder, 'orpheu_version_auto.h'), 'w') as fp:
    fp.write("""
#ifndef _ORPHEU_AUTO_VERSION_INFORMATION_H_
#define _ORPHEU_AUTO_VERSION_INFORMATION_H_

#define ORPHEU_BUILD_TAG        \"{0}\"
#define ORPHEU_BUILD_CSET       \"{1}\"
#define ORPHEU_BUILD_MAJOR      \"{2}\"
#define ORPHEU_BUILD_MINOR      \"{3}\"
#define ORPHEU_BUILD_RELEASE    \"{4}\"
#define ORPHEU_BUILD_LOCAL_REV  \"{9}\"

#define ORPHEU_BUILD_UNIQUEID   "{9}:" ORPHEU_BUILD_CSET

#define ORPHEU_VERSION_STRING   \"{5}\"
#define ORPHEU_VERSION_FILE     {6},{7},{8},0

#endif /* _ORPHEU_AUTO_VERSION_INFORMATION_H_ */
